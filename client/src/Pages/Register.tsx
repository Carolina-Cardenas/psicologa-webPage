...
const steps = [
  { title: "Datos personales", subtitle: "Cuéntanos sobre ti" },
  {
    ...
    subtitle: "Para poder comunicarnos contigo",
  },
  {
    title: "Sobre tu consulta",
    subtitle: "Esto nos ayuda a preparar tu primera sesión",
  },
  {
    title: "Crea tu cuenta",
    subtitle: "Casi listo, solo falta asegurar tu acceso",
  },
];
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(
        "http://localhost:4000/api/client/auth/register",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            terapiaPrevia: formData.terapiaPrevia || undefined,
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 1:
        return !!(formData.telefono && formData.email && formData.pais);
      case 2:
        return !!formData.motivoConsulta;
      case 3:
        return !!(
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          update("fechaNacimiento", e.target.value)
                        }
                        required
                      />
                    </div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) => update("modalidadPreferida", v)}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="Selecciona" />
                        </SelectTrigger>
                  ...
                  <>
                    <div className="space-y-2">
                      <Label htmlFor="motivoConsulta">
                        ¿Qué te motiva a buscar terapia? *
                      </Label>
                      <Textarea
                        id="motivoConsulta"
                        ...
                        onChange={(e) =>
                          update("motivoConsulta", e.target.value)
                        }
                        required
                      />
                      <p className="text-xs text-muted-foreground">
                        Esta información nos ayuda a preparar mejor tu primera
                        sesión. No te preocupes, es completamente confidencial.
                      </p>
                    </div>
                    <div className="space-y-2">
                      <Label>¿Has tenido terapia antes?</Label>
                      <Select
                        value={formData.terapiaPrevia}
                        onValueChange={(v) => update("terapiaPrevia", v)}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="Selecciona" />
                        </SelectTrigger>
                        <SelectContent>
                          ...
                          <SelectItem value="si-buena">
                            Sí, y fue una buena experiencia
                          </SelectItem>
                          <SelectItem value="si-no-bien">
                            Sí, pero no me fue tan bien
                          </SelectItem>
                          <SelectItem value="prefiero-no-decir">
                            Prefiero no decir
                          </SelectItem>
